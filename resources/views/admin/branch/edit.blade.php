    ...
    <div class="content-wrapper" style="min-height: 1419.51px;">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <form action="{{ route('admin.update', ['id' => $branch->id]) }}" method="post" id="form"
                            name="pForm" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            <div class="form-row">
                                <!-- Branch Name -->
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input class="form-control" name="branch_name" id="branch_name"
                                        placeholder="Branch Name" value="{{ $branch->branch_name ?? '' }}" required />
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input class="form-control" name="branch_code" id="branch_code"
                                        placeholder="Branch Code" value="{{ $branch->branch_code ?? '' }}" required />
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input class="form-control" name="owner_name" id="owner_name" placeholder="Owner Name"
                                        value="{{ $branch->owner_name ?? '' }}" required />
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <select class="form-select select2 form-control js-select2" name="country_name"
                                        id="country" required>
                                        <option selected disabled value="">Select Country</option>
                                        @foreach ($countries as $country)
                                            <option {{ $branch->country_name == $country->id ? 'selected' : '' }}
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <select class="form-select select2 form-control js-select2" name="state_name"
                                        id="states" required>
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <select class="form-select select2 form-control js-select2" name="district_name"
                                        id="district_name" required>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <textarea class="form-control" name="address1" id="address1" placeholder="Address 1" required>{{ $branch->address1 ?? '' }}</textarea>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <textarea class="form-control" name="address2" id="address2" placeholder="Address 2">{{ $branch->address2 ?? '' }}</textarea>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select form-control" name="user_status" id="user_status"
                                        ...
                                        <option value="active" {{ $branch->user_status == 'active' ? 'selected' : '' }}>
                                            Active</option>
                                        <option value="inactive"
                                            {{ $branch->user_status == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                    @error('user_status')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" value="{{ $branch->user->email }}" name="loginId" id="loginId" placeholder="Login Id"
                                        required>
                ...
                if (selectedCountryId) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            let selectedState;
                            $.each(data, function(key, value) {
                                selectedState = (value.id == selectedStateId) ?
                                    'selected' : ''
                                $('#states').append('<option value="' + value.id +
