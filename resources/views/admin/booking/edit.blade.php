    ...
    <div class="content-wrapper" style="min-height: 1419.51px;">
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{ url('admin/bookings/update/' . $booking->id . '?booking=' . $booking->booking_status) }}" method="POST" enctype="multipart/form-data">

                    @csrf
                    <div class="row">
                        @include('admin.booking.shared.edit_client_booking')
                        <div class="col-md-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <!-- Distance -->
                                            ...
                                            <input type="hidden" readonly value="{{ $booking->booking_status }}" name="booking_status" id="status"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" readonly value="{{ $booking->distance }}" name="distance" id="distance"
                                                class="form-control mb-1" oninput="calculateInvoice()" />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" readonly value="{{ $booking->freight_amount }}" name="freight_amount"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->wbc_charges }}" readonly name="wbc_charges"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->handling_charges }}" name="handling_charges"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->fuel_amount }}" name="fuel_amount" id="fuel_amount"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->transhipmen_one_amount }}" readonly name="transhipmen_one_amount"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->transhipmen_two_amount }}" readonly name="transhipmen_two_amount"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->transhipment_three_amount }}" readonly name="transhipment_three_amount"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->pickup_charges }}" name="pickup_charges" id="pickup_charges"
                                                class="form-control mb-1" oninput="calculateInvoice()" />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->hamali_Charges }}" readonly name="hamali_Charges"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->bilti_Charges }}" readonly value="10"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="discount" id="discount" value="{{ $booking->discount }}"
                                                class="form-control mb-1" oninput="calculateInvoice()" />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->compney_charges }}" name="compney_charges"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->misc_charge_amount }}" name="misc_charge_amount"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->sub_total }}" name="sub_total" id="sub_total"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->cgst }}" name="cgst" id="cgst"
                                                class="form-control mb-1" readonly />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->sgst }}" name="sgst" id="sgst"
                                                class="form-control mb-1" readonly />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->igst }}" name="igst" id="igst"
                                                class="form-control mb-1" readonly />
                                        </div>
                                        <!-- Grand Total -->
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" readonly value="{{ $booking->grand_total }}" name="grand_total"
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" value="{{ $booking->grand_total_amount }}" name="grand_total_amount"
