        ...
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/careers/store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-control select2" name="state_id" id="states">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select class="form-control select2"  name="location" id="district_name">
                            ...
                            <div class="col-sm-12">
                                ...
                                <select name="staff_type" class="form-control select2" id="staff"
                                    data-placeholder="Staff Type">
                            ...
                            <div class="col-sm-6 mt-3">
                                ...
                                <a href="{{ url('admin/careers') }}" class="btn btn-secondary">Back </a>
                            </div>
