...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <span class="dropdown-item dropdown-header">{{ __('Select Language') }}</span>
                        <div class="dropdown-divider"></div>
                        <a href="{{ url('lang/en') }}" class="dropdown-item {{ app()->getLocale() == 'en' ? 'active' : '' }}">
                            <i class="flag-icon flag-icon-us mr-2"></i> {{ __('English') }}
                            @if(app()->getLocale() == 'en')
                            <span class="float-right text-muted text-sm"><i class="fas fa-check"></i></span>
                            @endif
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="{{ url('lang/hi') }}" class="dropdown-item {{ app()->getLocale() == 'hi' ? 'active' : '' }}">
                            <i class="flag-icon flag-icon-in mr-2"></i> {{ __('Hindi') }}
                            @if(app()->getLocale() == 'hi')
                            <span class="float-right text-muted text-sm"><i class="fas fa-check"></i></span>
                            @endif
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="#" class="dropdown-item dropdown-footer">{{ __('See All Languages') }}</a>
                    </div>
                </li>
                {{-- <li class="nav-item">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} <a href="#">Bitnova</a>.</strong>
            All rights reserved.
