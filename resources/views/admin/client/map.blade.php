    ...
    <div class="content-wrapper" style="min-height: 1419.51px;">
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/clients/maps') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label for="client_id" class="form-label">Select Client</label>
                                <select class="form-select select2 form-control js-select2" name="client_id" id="client_id"
                                    required>
                                ...
                                <div class="form-check">
                                    @foreach ($branch as $branchList)
                                        <div class="form-check mb-1">
                                            <input class="form-check-input" type="checkbox" name="client_branch_id[]"
                                                value="{{ $branchList->id }}" id="branch_{{ $branchList->id }}">
