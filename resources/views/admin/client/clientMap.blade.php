    ...
    <div class="content-wrapper" style="min-height: 1419.51px;">
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/clients/mapClient') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                <label for="client_id" class="form-label">Select Client</label>
                                <select name="from_client_id" id="from_client_id" class="form-select select2 form-control js-select2" required>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-2">
                                ...
                                <div class="form-check">
                                    @foreach ($clients as $client)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="to_client_ids[]"
                                            value="{{ $client->id }}" id="to_client_id{{ $client->id }}">
                                        <label class="form-check-label" for="to_client_{{ $client->id }}">
                                            {{ $client->client_name }}
                                        </label>
                                    </div>
                                @endforeach
