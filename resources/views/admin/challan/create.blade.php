                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{ old('driverMobile') }}" type="text" placeholder="Driver Mobile" class="form-control" id="driverMobile"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Lock Number" class="form-control" id="locknumber" value="{{ old('locknumber') }}"
                                    name="locknumber">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Co Loder" class="form-control" id="co-loder" value="{{ old('coLoder') }}"
                                    name="coLoder">
                            </div>
                        </div>
                        <div class="col-md-4">
