    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <form action="{{ url('admin/distances/update') }}" method="post" id="form" name="pForm"
                            enctype="multipart/form-data" class="needs-validation" novalidate>
                            <input type="hidden" value="{{ $distance->id }}" name="id"/>
                            @csrf
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select class="form-select select2 form-control js-select2" name="from_branch_id" id="from_branch_id">
                                        <option value="">From</option>
                                        @foreach ($branches as $branchList)
                                            <option value="{{ $branchList->id }}" 
                                                {{ $branchList->id == $distance->from_branch_id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select class="form-select select2 form-control js-select2" name="to_branch_id"
                                        ...
                                        @foreach ($branches as $branchList)
                                        <option value="{{ $branchList->id }}" 
                                            {{ $branchList->id == $distance->to_branch_id ? 'selected' : '' }}>
                                            {{ $branchList->branch_name }}
                                        </option>
                                    @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input class="form-control" value="{{ $distance->distance }}" name="distance" id="distance" />
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select class="form-select select2 form-control js-select2" name="status" id="status">
                                        <option value="">Select Status</option>
                                        <option value="1" {{ $distance->status == 1 ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{ $distance->status == 0 ? 'selected' : '' }}>Inactive</option>
                                    </select>
